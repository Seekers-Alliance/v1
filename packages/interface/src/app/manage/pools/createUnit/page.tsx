...
export default function Page() {
    ...
    const poolNames=['Unit Pool A : Rares', 'Unit Pool B : Uncommons', 'Unit Pool C : Commons']
  ...
  return (
    <div className='flex flex-col justify-start'>
        <div className='mt-[38px] w-[950px] flex flex-col gap-4'>
        {poolNames.slice(0, poolAmount).map((poolName, index) => {
            return (
                <SetUnitProbabilitySection poolName={poolName} key={index}/>
            )})}
        </div>
