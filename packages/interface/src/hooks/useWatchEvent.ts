...
export default function useWatchEvent<T>(fetchFn:()=>Promise<T|null>, intervalInSecond =1 ) {
    ...
    useEffect(() => {
        ...
        fetchEvents().then(()=>console.log('fetched events')).catch((err)=>console.log(err));
